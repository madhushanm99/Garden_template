...
const ServiceDetails = () => {
  ...
  const handleCityClick = (item) => {
    setSelectedCity(item);
      ...
      // Find the selected city's data from the array of cities
      const cityData = cities[selectedDistrict].find(city => city.label === item.label);
      
  
      if (cityData) {
        // Extract the rainfall data for the chart
        const rainfall = [
          cityData.day1,
          cityData.day2,
          cityData.day3,
